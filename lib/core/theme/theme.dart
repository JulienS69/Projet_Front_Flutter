...
final ThemeData myTheme = ThemeData(
  ...
  primaryColor: Color(0xff2b2e41),
  primaryColorLight: Color(0xffe0e2eb),
  primaryColorDark: Color(0xff2b2e42),
  canvasColor: Color(0xfff8f8fa),
  scaffoldBackgroundColor: Color(0xfff8f8fa),
  bottomAppBarColor: Color(0xffffffff),
  cardColor: Color(0xffffffff),
  dividerColor: Color(0xffe1e1e4),
  highlightColor: Color(0x66bcbcbc),
  splashColor: Color(0x66c8c8c8),
  selectedRowColor: Color(0xfff8f8fa),
  unselectedWidgetColor: Color(0xffc2c2c8),
  disabledColor: Color(0xffe3e3e3),
  toggleableActiveColor: Color(0xffE20917),
  secondaryHeaderColor: Color(0xffffffff),
  backgroundColor: Color(0xff868793),
  dialogBackgroundColor: Color(0xffffffff),
  indicatorColor: Color(0xffccd0dc),
  hintColor: Color(0xff6c6c6c),
  errorColor: Color(0xffE20917),
  buttonTheme: ButtonThemeData(
    ...
    buttonColor: Color(0xffE20917),
    disabledColor: Color(0xffe3e3e3),
    highlightColor: Color(0x00000000),
    splashColor: Color(0xff000000).withOpacity(0.122),
    focusColor: Color(0xff000000).withOpacity(0.122),
    hoverColor: Color(0xff000000).withOpacity(0.039),
    colorScheme: ColorScheme(
      primary: Color(0xff2b2e42),
      primaryContainer: Color(0xff3d415c),
      secondary: Color(0xff666d99),
  ...
  tooltipTheme: TooltipThemeData(padding: EdgeInsets.all(8)),
  textTheme: TextTheme(
    headline1: TextStyle(
  ...
  primaryTextTheme: TextTheme(
    ...
    caption: TextStyle(
      color: Color(0xffffffff).withOpacity(0.702),
      fontSize: 12,
      fontWeight: FontWeight.w400,
      fontStyle: FontStyle.normal,
      fontFamily: "Roboto",
  ...
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ButtonStyle(
      backgroundColor: MaterialStateProperty.all(Color(0xffe20917)),
    ),
  ),
  sliderTheme: SliderThemeData(
    activeTrackColor: Color(0xff2b2e42),
    ...
    disabledActiveTickMarkColor: Color(0xccE20917),
    disabledInactiveTickMarkColor: Color(0xccffffff),
  ...
  colorScheme: ColorScheme.fromSwatch(
      primarySwatch: MaterialColor(4281019969, {
    50: Color(0xfff0f0f5),
  ...
  })).copyWith(secondary: Color(0xffE20917)),
